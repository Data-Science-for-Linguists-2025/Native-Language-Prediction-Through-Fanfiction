...
From there, I continued on to [#hope](nbviewer.org/Github/Classification.ipynb#hope) where I isolated all word features so as to break up different features of words and created a list of all punctuation used. From this, I took out punctuation that can be used in quotations and made a binary feature for each work of whether or not it contains a particular form of quotation markings.
